...
const TwoFactorVerify: React.FC<TwoFactorVerifyProps> = ({
  ...
  const handleVerifyRecoveryCode = async () => {
    ...
    try {
      ...
      const response = await api.post('/user/2fa/recovery', {
        sessionToken,
        ...
        <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8">
          <div className="bg-red-50 border-l-4 border-red-400 rounded-r-lg p-6">
            <div className="flex items-start">
              ...
              <div>
                <h2 className="text-xl font-bold text-red-900 mb-2">Sessione Scaduta</h2>
            ...
            {onCancel && (
              <Button onClick={onCancel} variant="primary" className="w-full mt-4">
                Torna al Login
              </Button>
            )}
          </div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className={`h-2 rounded-full transition-all ${
                  timeLeft < 60 ? 'bg-red-600' : 'bg-gradient-to-r from-blue-500 to-indigo-600'
                }`}
            ...
            <div className="mb-6">
              ...
              {remainingAttempts !== null && remainingAttempts > 0 && (
                <p className="text-xs text-red-600 mt-2 font-semibold">
                  ⚠️ Tentativi rimanenti: {remainingAttempts}
                </p>
              )}
            </div>
          )}
            ...
            <div>
              ...
              <div className="mb-6">
                <Input
                  ...
                  autoFocus
                />
                <p className="text-xs text-gray-500 mt-2 text-center">Formato: XXXX-YYYY (8 caratteri)</p>
              </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            {!useRecoveryCode ? (
              <button
                ...
                disabled={loading}
                className="text-sm text-blue-600 hover:text-blue-700 w-full text-center font-medium transition-colors"
              >
