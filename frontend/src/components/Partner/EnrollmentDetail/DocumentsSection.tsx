        ...
        <div className="w-full bg-amber-50 border border-amber-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div className="text-sm text-amber-800">
              <p className="font-semibold mb-1">Gestione documenti partner:</p>
              <ul className="list-disc list-inside space-y-1 text-amber-700">
                <li><strong>Approva</strong> documenti conformi per completare il processo</li>
                <li><strong>Rifiuta</strong> documenti non conformi con motivazione dettagliata</li>
                <li>L'utente riceverà notifica email automatica per ogni decisione</li>
                <li>Documenti approvati non possono essere eliminati dall'utente</li>
                <li>Utilizza l'anteprima per verificare qualità e conformità</li>
              </ul>
            </div>
          </div>
        </div>
