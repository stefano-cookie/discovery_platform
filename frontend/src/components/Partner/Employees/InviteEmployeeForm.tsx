...
const InviteEmployeeForm: React.FC<InviteEmployeeFormProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    firstName: '',
    lastName: '',
    role: PartnerEmployeeRole.COMMERCIAL
  });
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            >
              <option value={PartnerEmployeeRole.COMMERCIAL}>COMMERCIAL - Accesso limitato</option>
              <option value={PartnerEmployeeRole.ADMINISTRATIVE}>ADMINISTRATIVE - Accesso completo</option>
            </select>
            {errors.role && (
